...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.image.style1', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-left', speed: 1000, intensity: 0, delay: 0, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-in', speed: 1000, intensity: 0, delay: 0, replay: false });
